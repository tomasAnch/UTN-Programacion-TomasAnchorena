...
# nota = float(input("Decime la nota que sacaste: "))
# if ( nota ) >= 6:
#     print("Aprobado")
# else:
#     print("Desaprobado")
...
# num = int(input("Ingresá un número para ver si es par o no: "))
# if ( num ) % 2 == 0:
...
# contraseña = (input("Escribí una contraseña que tenga entre 8 y 14 caracteres: "))
...
#6) La moda (mode), la mediana (median) y la media (mean) son parámetros estadísticos que se pueden utilizar para predecir la forma de una distribución normal a partir del siguiente criterio:
...
# frase_palabra = input("Ingresá una frase o palabra: ")
...
# opcion = int(input("Seleccione la opción que deseé: "))
# if ( opcion ) == 1:
#     print(nombre.upper())
# elif ( opcion ) == 2:
#     print(nombre.lower())
...
# magnitud_terremoto = int(input("Decime cual fue la magnitud del terremoto: "))
...
# hemisferio = input("Decime en que hemisferio te encontrás (N/S): ").upper()
# mes = int(input("Decime el mes (1-12): "))
# dia = int(input("Decime el día (1-31): "))
